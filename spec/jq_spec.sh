...
Describe '2021 jq advent of code'
  Describe "1a script"
    ...
    It "must output $2 for 2021/$1.input"
  ...
  Describe '2a script'
    ...
    It "stderr line $3 should match $4 for $1.input"
      When run jq --slurp --raw-input --from-file "2021/jq/2a.jq" "2021/$1.input"
  ...
  Describe '3a script'
    ...
    It "stderr should equal $3 for $1.input"
      When run jq -L 2021/jq --slurp --raw-input --from-file "2021/jq/3a.jq" "2021/$1.input"
  ...
  Describe '3b script'
    Parameters
      # File      # Result  # Err Line Should match
      03_demo       "198"      '["DEBUG:",{"oxygen":23,"cO2":10}]'
      03_blackthorn "?"        '["DEBUG:",{"oxygen":??,"cO2":??}]'
    End

    It "must output $2 for $1.input"
      When run jq -L 2021/jq --slurp --raw-input --from-file "2021/jq/3b.jq" "2021/$1.input"
      The stderr should match pattern "*DEBUG*"
      The output should eq "$2"
      The status should be success
    End
